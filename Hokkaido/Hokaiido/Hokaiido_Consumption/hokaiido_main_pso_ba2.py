...
############################################# Test Data Set#########################################################
    ...
    ################# Begin Import the train data1(training data japan1.csv) ##################
    with open(r'E:\L\Hokkaido\Hokaiido\Hokaiido_Consumption\test data japan1.csv', 'r', encoding='utf-8', newline='') as csvfile:
        reader = csv.reader(csvfile)
        # Skip the title row（if have）
        next(reader)
        # Define the index of columns
    ...
    ################# Begin Import the train data2(actual data)(training data japan2.csv) ##############
    with open(r'E:\L\Hokkaido\Hokaiido\Hokaiido_Consumption\test data japan2.csv', 'r', encoding='utf-8', newline='') as csvfile2:
        reader2 = csv.reader(csvfile2)
        # Skip the title row（if have）
        next(reader2)
        # Define the index of columns
