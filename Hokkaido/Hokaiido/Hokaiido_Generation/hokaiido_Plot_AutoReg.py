...
with open(r'E:\L\Hokkaido\Hokaiido\Hokaiido_Generation\hokaiido_Plot_AutoReg.csv', 'r', encoding='utf-8', newline='') as csvfile:
...
# 添加图例
plt.legend()
plt.savefig("Hokaiido_Generation_AutoReg", dpi=750)
